...
export default [
  ...
  route("blog", "../screens/BlogList.tsx", { id: "blog-list" }),
  route("blog/:title", "../screens/BlogDetail.tsx", { id: "blog-detail" }),
  route("compare", "../screens/BlogList.tsx", { id: "compare-list" }),
  route("compare/:title", "../screens/BlogDetail.tsx", { id: "compare-detail" }),
