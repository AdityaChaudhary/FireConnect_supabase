                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-10 py-12 border-t border-white/5">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="flex gap-4">
                                <a className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-fire-pink transition-colors text-white" target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/fireconnect.me">
                                ...
                                <a className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-fire-pink transition-colors text-white" target="_blank" rel="noopener noreferrer" href="https://x.com/FireConnect_me">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                                        <path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932 6.064-6.932zm-1.294 19.497h2.039L6.482 3.239H4.294l13.313 17.411z"/>
                                    </svg>
                                </a>
                            </div>
                        </div>
